...
local timerAdds                       = mod:NewTimer(5, "TimerAdds", 61131)
local timerDominateMind               = mod:NewBuffActiveTimer(27, 71289)
local timerDominateMindCD             = mod:NewCDTimer(40, 71289)
local timerSummonSpiritCD             = mod:NewCDTimer(12, 71426, nil, false)
local timerFrostboltCast              = mod:NewCastTimer(12, 72007)
